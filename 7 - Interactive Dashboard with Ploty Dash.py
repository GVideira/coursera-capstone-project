...
def get_scatter_chart (launch_site, payload_range):
    filtered_df_2 = spacex_df[spacex_df['Payload Mass (kg)'].between(payload_range[0],payload_range[1])]
    if launch_site == 'ALL':
        fig = px.scatter(filtered_df_2, x= 'Payload Mass (kg)',y = 'class', color ='Booster Version Category')
        return fig 
    else:
        filtered_df_2 = filtered_df_2[filtered_df_2['Launch Site'] == launch_site]
        fig = px.scatter(filtered_df_2, x= 'Payload Mass (kg)',y = 'class', color ='Booster Version Category')
        return fig
